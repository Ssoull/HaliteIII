...
class Dstar {
 ...
 public:
  ...
  void   initWithPosition(hlt::Position startPos, hlt::Position goalPos);
 ...
 private:
  ...
  //Update coordinates with a modulo of the map size to use toroidal coordinates
  state  moduloSucc(state u, int x, int y);
